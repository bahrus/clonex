...
export async function spawnAll(clone, options) {
    ...
    for (const key in options) {
        if (key !== 'spawnCallback' && !isNaN(parseInt(key))) {
            ...
            doSyncSpawns(options[key], nodeIndex, nodes, options, elementToInfoMap);
        }
    }
